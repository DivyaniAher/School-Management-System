...
public class Teacher {
	...
	public void Teacher() throws IOException {
		...
		try {
			...
			PreparedStatement ps = conn.prepareStatement("select * from teacher where username=?");
			...
			if(password.equals(userPassword)) {
				...
				do {
					...
					case 3:
						...
						System.out.println("                                                                                  STUDENT TABLE                                                                                       ");
						System.out.println("======================================================================================================================================================================================");
						System.out.println("teacherId \t\tfirst_name\t\tlast_name\t\tmiddle_name\t\tmother_name\t\tgender\t\tdate\t\temail\t\tphone\t\taddress\t\tadd_date");
						System.out.println("======================================================================================================================================================================================");
						
						
						ps = conn.prepareStatement("select * from teacher");
						ResultSet teacher = ps.executeQuery();

						while (teacher.next()) {
							System.out.println(teacher.getInt("studId") +"\t\t"+teacher.getString("first_name") +"\t\t"+teacher.getString("last_name")+"\t\t"
						            +teacher.getString("middle_name")+"\t\t"+teacher.getString("mother_name")+"\t\t"+teacher.getString("gender")+"\t\t"
									+teacher.getDate("dob")+"\t\t"+teacher.getString("email")+"\t\t"+teacher.getLong("phone")+"\t\t"
						            +teacher.getString("address")+"\t\t"+teacher.getDate("add_date"));
						}
						System.out.println("===================================================================================================================================");
